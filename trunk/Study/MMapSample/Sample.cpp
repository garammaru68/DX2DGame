...
public:
	...
	bool Render()
	{
		...
		m_pContext->UpdateSubresource(
			m_dxObj.m_pConstantBuffer.Get(), 0, NULL, &m_cbData, 0, 0);
...
public:
	bool Init()
	{
		...
		m_PlaneObj.Create(m_pd3dDevice, m_pContext,
			L"../../../data/gg.bmp",
		...
		m_BoxObj.Create(m_pd3dDevice, m_pContext,
			L"../../../data/loading.bmp",
			L"../../../data/Shader/ShapeShader.txt");
		m_BoxObj.m_pBlendState = MDxState::g_pBSAlphaBlend;
		m_BoxObj.m_pSamplerState = MDxState::g_pSamplerState;

		m_GameMap.CreateHeightMap(m_pd3dDevice, L"../../../data/map/heightMap513.bmp");
		m_GameMap.Create(m_pd3dDevice, m_pContext,
			L"../../../data/gg.bmp",
			L"../../../data/Shader/shapeShader.txt");
	...
	bool Frame()
	{
		...
		//m_fYaw += D3DXToRadian(g_InputData.iMouseValue[2]);
		...
		m_pMainCamera->Update(D3DXVECTOR3(m_fPitch, m_fYaw, m_fRoll),
			g_InputData.iMouseValue[2]);
		m_pMainCamera->Frame();
